...
- [Fashionpedia Experiments (LoRA / Prompt)](#fashionpedia-experiments-lora--prompt)
...
## Fashionpedia Experiments (LoRA / Prompt)

本项目在 Fashionpedia val 上进行了 Grounding DINO + SAM2 的 prompt 工程与 LoRA 微调实验。

- **文档**：[FASHIONPEDIA.md](FASHIONPEDIA.md)（结论、命令、可视化）
- **实验记录**：[EXPERIMENT_LOG.md](EXPERIMENT_LOG.md)
- **对比图**：`outputs/figures/` · **Failure cases**：`outputs/failure_viz_th015/`
